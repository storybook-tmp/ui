...
export const CssCheck: Story = {
  ...
  play: async ({ canvas }) => {
    ...
    // TaskStatusBadge applies custom purple fill for SetupFailed via styled-component.
    // purple.light2 resolves to rgb(241, 212, 253) at runtime.
    const bg = getComputedStyle(badge).backgroundColor;
    await expect(bg).toBe('rgb(241, 212, 253)');
  },
};
